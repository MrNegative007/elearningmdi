                    ...
                    <div class="card pt-4">
                        <div class="card-body">
                            <div class="text-center mb-5">
                                ...
                                <h3>E-Learning MI Dakwah Islamiyah</h3>
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group position-relative has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" id="username" placeholder="Masukan username">
